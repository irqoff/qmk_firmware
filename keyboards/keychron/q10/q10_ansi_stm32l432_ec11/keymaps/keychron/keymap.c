...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_CTL_A_GUI_SPC] = ACTION_TAP_DANCE_DOUBLE(LCTL(KC_A), LGUI(KC_SPC)),
  [TD_CTL_C_ENT] = ACTION_TAP_DANCE_DOUBLE(LCTL(KC_C), KC_ENT),
  [TD_CTL_V_BSPC] = ACTION_TAP_DANCE_DOUBLE(LCTL(KC_V), KC_BSPC),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_89(
        ...
        TD(TD_CTL_D_CTL_Z), TD(TD_CTL_A_GUI_SPC),                    KC_Z,  KC_X,          KC_C,    KC_V,          KC_B,     TD(TD_CTL_C_CTL_V), KC_N,           KC_M,  KC_COMM,        KC_DOT,   KC_SLSH,  KC_LEFT_GUI, KC_UP,
        MEH_T(KC_DEL),      TD(TD_CTL_C_ENT),     TD(TD_CTL_V_BSPC),        OSM(MOD_LALT), KC_SPC,  OSM(MOD_LSFT),                               LSFT_T(KC_SPC),        RCTL_T(KC_ESC),                     KC_LEFT,     KC_DOWN, KC_RGHT),
